		...
		function myCheck() {
			...
			if(winCount == 27){
				var imageUrl = "file:///U:/11th%20grade%20website%20revised/Css/images/confetti.gif";
				$(document).ready(function(){
